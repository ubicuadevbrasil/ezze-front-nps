		...
		<BaseTemplate>
			...
			<div className="w-full pt-2 pb-4 px-3 gap-5 flex flex-row  items-center justify-between">
				...
				<div className="gap-2 flex">
					<Button className="rounded-md -sm px-3 py-2.5 border border-[#104b94] text-[#104b94]" variant={'outline'}>
						Responder Pesquisa
					</Button>
					<Button className="rounded-md -sm px-3 py-2.5 border border-[#104b94] text-[#104b94]" variant={'outline'}>
			...
			<div className="grid grid-cols-3 grid-rows-3 gap-2 mx-3">
				<div className="row-span-2 py-2 px-4 bg-white flex flex-col gap-1 rounded-md -sm">
				...
				<div className="col-span-2 row-span-2 py-2 px-4 bg-white flex flex-col gap-2 rounded-md -sm">
				...
				<div className="py-2 px-4 bg-white flex flex-col gap-4 rounded-md -sm">
					<h2 className="text-slate-900 font-medium text-sm">Atividades</h2>
					<div className="flex items-center gap-4">
						<div className="bg-[#104b94] rounded-md -full p-2 w-fit">
				...
				<div className="col-span-2 py-2 px-4 pt-2 pb-3 bg-white flex flex-col gap-2 rounded-md -sm">
			...
			<div className="flex flex-col gap-6 mt-2 mx-3 py-2 px-4 rounded-md -sm bg-white ">
