...
const NewPassword: React.FC = () => {
	...
	return (
		<>
			<Link to={'/recover-password'} className="flex gap-2.5 self-start items-center mb-3 py-2 px-3 rounded bg-[#D9DDE5]">
			...
			<input type="text" className="w-full py-4 px-3 mb-2 rounded border border-[#B6AFAF] bg-[#F1F3FE] font-semibold text-2xl text-[#365DA5] text-center outline-none" />
