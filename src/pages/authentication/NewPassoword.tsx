...
const NewPassword: React.FC = () => {
  ...
  return (
    <>
      ...
      <input type="text"
        className='w-full py-4 px-3 mb-2 rounded border border-[#B6AFAF] bg-[#F1F3FE] font-semibold text-2xl text-[#365DA5] text-center outline-none'
      />
      ...
      >
        <div className="w-full flex py-2 px-3 bg-white rounded border border-[#C0C7D4]">
          <div className="w-full flex flex-col">
              ...
              <input 
                type={visible ? 'text' : 'password'} id='password' placeholder='Digite aqui a senha'
        ...
        <button disabled={isSubmitDisable} className='w-full flex justify-center py-2 bg-[#365DA5] text-white rounded disabled:opacity-40'>Alterar senha</button>
      </form>
    </>
  );
}
