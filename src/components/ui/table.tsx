...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "border border-[#B6AFAF] text-sm font-medium h-12 px-3 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("border border-[#B6AFAF] text-xs py-1 px-3 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
